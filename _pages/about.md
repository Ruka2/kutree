...
| **Key Technologies and Applications of Human-Computer Interaction Perception Strategies Enhanced by Large Models (基于大模型增强的人机交互感知策略关键技术研究与应用)**|   
| :------ |   
| ***KU SU WA***, Chenglong Ma, Ho Kuok Tou|  
| Project Funding Application from FDCT, October, 2025, Pachira (International) Technology Co., Ltd.|  

| **Intent-Enhanced & Slot-Refined Dialogue System via Agent Framework (基于智能体框架的意图理解与槽位提取强化的对话系统)**|   
| :------ |   
| ***KU SU WA***|  
| Talent funding from the Macau FDCT, May, 2025.|  

| **Self-learning and Dynamic Planning Agent for In-Vehicle Systems (车载系统之自适应学习与规划的智能体研发与应用)**|   
| :------ |   
| Chenglong Ma, ***KU SU WA***, Ho Kuok Tou|  
| Project Funding Application from FDCT, October, 2024, Pachira (International) Technology Co., Ltd.|  

| **Self-GAR: Self-reflection for Generative Adversarial Reasoning in Large Language Models**|   
| :------ |   
| ***KU SU WA***|  
| Thesis Dissertations in 2024, University of Macau. [Online Version](https://umlibrary.primo.exlibrisgroup.com/discovery/fulldisplay?docid=alma991010450375106306&context=L&vid=853UOM_INST:umlibrary&search_scope=MyInst_and_CI&adaptor=Local%20Search%20Engine&tab=Everything&query=any,contains,KU%20SU%20WA). |  
...
| **Speech Recognition Method, Apparatus, Device and Storage Medium (语音识别方法、装置、设备及介质)**|   
| :------ |   
| Yuchu Lin, ***KU SU WA*** |  
...
| Year | Honor & Awards |
| :------ | :------ |  
| *2021* | Outstanding Undergraduate Student, Department of Computer and Information Science. ([News](https://www.fst.um.edu.mo/news/2020-2021-fst-graduates-stories-and-their-final-year-projects/)), ([Thesis](http://oaps.umac.mo/handle/10692.1/240)).| 
